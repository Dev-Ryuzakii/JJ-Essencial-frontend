  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        ...
        <Link 
          to="/products" 
          className="mt-4 sm:mt-0 inline-flex items-center text-purple-600 hover:text-purple-800"
        >
      ...
      {wishlistItems.length > 0 ? (
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          {/* Wishlist Header */}
          <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 hidden sm:grid sm:grid-cols-12 gap-4">
          ...
          <div className="divide-y divide-gray-200">
            {wishlistItems.map(item => (
              <div key={item.id} className="px-6 py-4 sm:grid sm:grid-cols-12 gap-4 items-center">
                {/* Product Info */}
                <div className="sm:col-span-7 flex items-center mb-4 sm:mb-0">
                ...
                {/* Price */}
                <div className="sm:col-span-2 text-right mb-4 sm:mb-0">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden py-12">
