...
**Before**:
```
POST https://jj-essencial.afribase.dev/api/v1/api/v1/customer-support/chat ❌
GET https://jj-essencial.afribase.dev/api/v1/api/v1/customer-support/my-chats ❌
```

**After**:
```
POST https://jj-essencial.afribase.dev/api/v1/customer-support/chat ✅
GET https://jj-essencial.afribase.dev/api/v1/customer-support/my-chats ✅
```
