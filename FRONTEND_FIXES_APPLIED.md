...
```typescript
// ✅ CORRECT (now)
const API_BASE_URL = 'https://jj-essencial-b33c39ba.afribase.dev/api/v1  ';
...
### ✅ **API Communication**:
- All calls go to `https://jj-essencial-b33c39ba.afribase.dev/api/v1  ` instead of Vite dev server
