...
```typescript
// ✅ CORRECT (now)
const API_BASE_URL = 'https://jj-essencial.afribase.dev/api/v1  ';
// All APIs now call: https://jj-essencial.afribase.dev/api/v1  /...
```
...
### ✅ **API Communication**:
- All calls go to `https://jj-essencial.afribase.dev/api/v1  ` instead of Vite dev server
